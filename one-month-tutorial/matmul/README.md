...
# Optimizing Matrix Multiplication on a CPU (C/C++)
* [Benchmarking Perfomance with OpenBLAS](https://salykova.github.io/matmul-cpu) 

* [Fast Matrix Multplication on CPU from Scatch ](https://siboehm.com/articles/22/Fast-MMM-on-CPU)


# Optimizing Matrix Multiplication on a GPU (CUDA)
WIP
